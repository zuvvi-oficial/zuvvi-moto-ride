-- criarContatoConfianca só checava o limite de 5 contatos em código de
-- aplicação (COUNT antes do INSERT) — clássica condição de corrida (TOCTOU):
-- duas requisições concorrentes do mesmo passageiro podiam passar ambas pela
-- checagem antes de qualquer uma delas inserir, resultando em mais de 5
-- contatos salvos. O mesmo padrão já existia em enderecos_favoritos (limite
-- de 10) e foi corrigido lá com um trigger + advisory lock (20260821212540);
-- replicando exatamente a mesma técnica aqui.
