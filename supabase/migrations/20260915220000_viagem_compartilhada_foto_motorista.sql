-- Exibe a foto de perfil já cadastrada do motorista na tela pública
-- de viagem compartilhada. Não altera a máquina de estados, localização,
-- SOS, mapa ou qualquer regra da corrida.
...
comment on function public.get_viagem_compartilhada_publica is
  'Leitura pública e minimalista de uma viagem compartilhada, incluindo somente a referência da foto do motorista para URL assinada no servidor.';
