...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      corrida_agendada_status: "agendada" | "convertida" | "cancelada" | "falhou";
      corrida_status:
        | "solicitada"
        | "buscando_motorista"
        | "aceita"
      ...
      documento_status_analise: "pendente" | "aprovado" | "recusado" | "correcao_solicitada";
      forma_pagamento: "pix" | "cartao" | "dinheiro";
      gorjeta_status: "pendente" | "paga" | "falhou";
      indicacao_status: "pendente" | "concluida";
      motorista_status:
        "draft" | "under_review" | "approved" | "suspended" | "rejected" | "em_analise";
      ...
      status_chamado_suporte: "aberto" | "em_atendimento" | "resolvido" | "fechado";
      tipo_chamado_suporte: "duvida" | "sos" | "reclamacao";
      tipo_chave_pix: "cpf" | "telefone" | "email" | "aleatoria";
      tipo_documento:
        "identidade" | "cnh" | "comprovante_residencia" | "crlv" | "foto_veiculo" | "foto_placa";
