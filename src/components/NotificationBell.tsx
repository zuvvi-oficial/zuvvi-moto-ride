...
const isPixOperationalNotice = (notification: NotificationBellItem) =>
  ...
  (notification.titulo === "Corrida cancelada" && notification.mensagem.includes("pagamento Pix"));
...
const getDateGroupLabel = (date: Date) => {
  ...
  const label = format(date, isThisYear(date) ? "d 'de' MMMM" : "d 'de' MMMM 'de' yyyy", {
    locale: ptBR,
  });
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload) => {
          ...
          queryClient.setQueryData(["notificacoes", userId], (old: NotificationBellItem[] = []) => [
            newNotif,
            ...old,
          ]);
          ...
          <>
            ...
            >
              ...
              {showPushPrompt && !showClearConfirm && (
                ...
                >
                  <BellPlus
                    className="mt-0.5 h-5 w-5 shrink-0 text-zuvvi-volt"
                    aria-hidden="true"
                  />
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-white/65">
                      Receba avisos mesmo com o app fechado: motorista aceitou, chegou,
                      cancelamentos e mais.
                    </p>
              ...
              {showClearConfirm && notificacoesVisiveis.length > 0 && (
                ...
                >
                  ...
                  <p className="mt-1.5 text-xs leading-relaxed text-white/65">
                    As notificações serão removidas desta central. Corridas, ganhos e pagamentos não
                    serão afetados.
                  </p>
                ...
                {notificacoesVisiveis.length === 0 ? (
                  <div className="flex flex-col items-center px-8 py-12 text-center">
                    ...
                    <p className="mt-1 max-w-[260px] text-sm leading-relaxed text-white/55">
                      Quando houver uma atualização importante sobre sua corrida, ela aparecerá
                      aqui.
                    </p>
                  </div>
                ) : (
