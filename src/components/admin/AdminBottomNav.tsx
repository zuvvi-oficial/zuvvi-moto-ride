...
export function AdminBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-zuvvi-indigo/95 backdrop-blur-xl border-t border-white/10 px-6 pt-3 pb-[calc(12px+env(safe-area-inset-bottom))] shadow-[0_-8px_30px_rgba(0,0,0,0.3)]">
        ...
        {items.map((item) => (
          <Link
            ...
            className={cn(
              ...
              item.active ? "text-zuvvi-violet" : "text-white/40"
            )}
          >
