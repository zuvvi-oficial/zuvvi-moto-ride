    ...
    <div className="min-h-screen bg-zuvvi-indigo-dark text-foreground flex flex-col pb-14">
      ...
      <main className="flex-1 max-w-md mx-auto w-full px-5 py-8 space-y-8 animate-rise">
        ...
        <Secao titulo="1. Quem é responsável pelos seus dados">
          <p>
            A Zuvvi Mobilidade Urbana ("Zuvvi", "nós") é a controladora dos dados pessoais tratados
            na plataforma, nos termos da Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD).
          </p>
        </Secao>
        ...
        <Secao titulo="7. Seus direitos como titular dos dados">
          ...
          />
          <p>
            Essas ações estarão disponíveis diretamente no seu perfil dentro do app. Até lá, envie
            um e-mail para{" "}
