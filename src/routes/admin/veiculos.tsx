  ...
  return (
    <div className="min-h-screen bg-zuvvi-indigo text-white flex flex-col">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 pb-24 md:pb-6">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-semibold ${
                        veiculo.status_aprovacao === "aprovado"
                          ...
                          : veiculo.status_aprovacao === "em_preenchimento"
                            ? "bg-amber-500/20 text-amber-500"
                            : veiculo.status_aprovacao === "em_analise"
                              ? "bg-sky-400/20 text-sky-400"
                              : veiculo.status_aprovacao === "suspenso"
                ...
                <Badge
                  className={cn(
                    ...
                    veiculo.status_aprovacao === "aprovado"
                      ...
                      : veiculo.status_aprovacao === "em_analise"
                        ? "bg-sky-400/20 text-sky-400 border-sky-400/20"
                        : veiculo.status_aprovacao === "suspenso"
          ...
          <DialogContent className="bg-zuvvi-indigo border-white/10 text-white">
            ...
            <div className="space-y-4 py-4">
              <p className="text-sm text-gray-400">
                Deseja realmente {actionType} o veículo <strong>{selectedVeiculo?.placa}</strong> de{" "}
                <strong>{selectedVeiculo?.usuarios?.nome}</strong>?
              </p>
              {actionType !== "aprovado" && (
            ...
            <DialogFooter>
              <Button variant="ghost" onClick={() => setSelectedVeiculo(null)}>
                Cancelar
              </Button>
              <Button
                className={
        ...
        <Sheet
          open={!!viewingVeiculoId}
          onOpenChange={(open) => !open && setViewingVeiculoId(null)}
        >
          <SheetContent
            side="right"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <Card className="bg-white/5 border-white/10 text-white">
                        <CardContent className="pt-6">
                          ...
                          <div className="mt-1 font-mono text-xl text-volt">
                              ...
                              className={
                                detalhe.veiculo.status_aprovacao === "aprovado"
                                  ...
                                  : detalhe.veiculo.status_aprovacao === "em_analise"
                                    ...
                                    : detalhe.veiculo.status_aprovacao === "suspenso"
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      {[
                        ...
                        <div key={field.id} className="space-y-1.5">
                          <Label htmlFor={field.id} className="text-xs text-gray-400 uppercase">
                            {field.label}
                          </Label>
                          <div className="flex gap-2">
                            <Input
                              ...
                              disabled={["recusado", "suspenso"].includes(
                                detalhe.veiculo.status_aprovacao,
                              )}
                            />
                            <Button
                              size="icon"
                              ...
                              disabled={
                                ["recusado", "suspenso"].includes(
                                  detalhe.veiculo.status_aprovacao,
                                ) || editData[field.id] === (detalhe.veiculo as any)[field.id]
                              }
                            >
                    ...
                    {detalhe.veiculo.motoristas ? (
                      <div className="bg-white/5 p-4 rounded border border-white/10 space-y-3">
                        <div className="flex justify-between items-start">
                          <div>
                            <div className="font-bold text-lg">
                              {detalhe.veiculo.motoristas.usuarios.nome}
                            </div>
                            <div className="text-sm text-gray-400">
                              {detalhe.veiculo.motoristas.usuarios.email}
                            </div>
                            <div className="text-sm text-gray-400">
                              {detalhe.veiculo.motoristas.usuarios.celular}
                            </div>
                          </div>
                          <Badge
                            variant="outline"
                            className={
                              detalhe.veiculo.motoristas.status_aprovacao === "aprovado"
                        ...
                        <div className="flex items-center gap-1 text-sm text-gray-400">
                          ...
                          {detalhe.veiculo.motoristas.usuarios.cidades?.nome}/
                          {detalhe.veiculo.motoristas.usuarios.cidades?.estado_uf}
                        </div>
                      </div>
                    ) : (
