    ...
    <div className="min-h-screen bg-zuvvi-indigo text-white flex flex-col">
      ...
      <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6 pb-24 md:pb-6">
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm text-gray-400">Total: {result.total} cidades cadastradas</div>
        </div>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="bg-zuvvi-indigo border-white/10 text-white">
                ...
                {ufs?.map((ufItem) => (
                  <SelectItem key={ufItem} value={ufItem}>
                    {ufItem}
                  </SelectItem>
                ))}
              </SelectContent>
              ...
              {result.cidades.map((cidade: any) => (
                ...
                >
                  ...
                  <TableCell className="text-right">
                    R$ {Number(cidade.bandeirada).toFixed(2)}
                  </TableCell>
                  <TableCell className="text-right">
                    R$ {Number(cidade.valor_km).toFixed(2)}
                  </TableCell>
                  <TableCell className="text-right">
                    R$ {Number(cidade.valor_min).toFixed(2)}
                  </TableCell>
                  <TableCell className="text-right">
                    R$ {Number(cidade.tarifa_minima).toFixed(2)}
                  </TableCell>
          ...
          <DialogContent className="bg-zuvvi-indigo border-white/10 text-white max-w-md">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                {novoStatus === "piloto" ? (
                  <Rocket className="w-5 h-5 text-volt" />
                ) : (
              ...
              <DialogDescription className="text-gray-400">
                ...
                <span className="text-white font-bold">
                  {selectedCidade?.nome} - {selectedCidade?.estado_uf}
                </span>
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="grid grid-cols-2 gap-2 text-[10px] bg-black/20 p-2 rounded">
                <div>
                  <span className="text-gray-500">Bandeirada:</span> R${" "}
                  {Number(selectedCidade?.bandeirada).toFixed(2)}
                </div>
                <div>
                  <span className="text-gray-500">KM:</span> R${" "}
                  {Number(selectedCidade?.valor_km).toFixed(2)}
                </div>
                <div>
                  <span className="text-gray-500">Minuto:</span> R${" "}
                  {Number(selectedCidade?.valor_min).toFixed(2)}
                </div>
                <div>
                  <span className="text-gray-500">Mínima:</span> R${" "}
                  {Number(selectedCidade?.tarifa_minima).toFixed(2)}
                </div>
                <div className="col-span-2">
                  <span className="text-gray-500">Comissão:</span> {selectedCidade?.comissao_pct}%
                </div>
              </div>
            ...
            <DialogFooter>
              ...
              <Button
                ...
                className={
                  novoStatus === "piloto"
                    ? "bg-volt text-black hover:bg-volt/80"
        ...
        <Dialog
          open={!!selectedCidadeTarifas}
          onOpenChange={(open) => !open && setSelectedCidadeTarifas(null)}
        >
          <DialogContent className="bg-zuvvi-indigo border-white/10 text-white max-w-xl">
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-400">
                Ajuste os valores operacionais para{" "}
                <span className="text-white font-bold">
                  {selectedCidadeTarifas?.nome} - {selectedCidadeTarifas?.estado_uf}
                </span>
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, bandeirada: Number(e.target.value) })
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, valor_km: Number(e.target.value) })
                  }
                  className="bg-white/5 border-white/10 text-white"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, valor_min: Number(e.target.value) })
                  }
                  className="bg-white/5 border-white/10 text-white"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, tarifa_minima: Number(e.target.value) })
                  }
                  className="bg-white/5 border-white/10 text-white"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, comissao_pct: Number(e.target.value) })
                  }
                  className="bg-white/5 border-white/10 text-white"
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setTarifasForm({ ...tarifasForm, raio_atuacao_km: Number(e.target.value) })
                  }
                  className="bg-white/5 border-white/10 text-white"
                />
              </div>
