...
function AdminDashboard() {
    ...
    return (<div className="min-h-[100dvh] overflow-x-hidden bg-zuvvi-indigo text-white flex flex-col">
      <AdminHeader action={<Button variant="ghost" size="sm" onClick={handleSignOut} className="h-9 px-3 sm:px-4 rounded-xl text-white/40 hover:text-white hover:bg-white/5 font-bold uppercase text-[10px] tracking-widest flex items-center gap-2 transition-all active:scale-95">
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-8 sm:space-y-12 pb-24 md:pb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {statCards.map((stat) => (<Card key={stat.title} className="bg-white/[0.025] border-white/10 text-white rounded-2xl min-w-0 transition-all hover:bg-white/[0.04] hover:border-white/20">
