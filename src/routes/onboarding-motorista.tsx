        ...
        {statusAprovacao === "em_analise" ? (
          <>
            {isCnhLoading ? (
              ...
              <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 text-center space-y-6">
                ...
                {cnhCorrection.motivo_correcao && (
                  <div className="bg-amber-500/5 border border-amber-500/10 rounded-xl p-4 text-left">
                    <p className="text-[10px] text-amber-500 uppercase font-black tracking-widest mb-1">
                      MOTIVO DA CORREÇÃO
                    </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="flex items-center gap-2">
                        <p
                          className={`text-xs font-bold ${cnhCorrection.is_expired ? "text-red-500" : ""}`}
                        >
                          {cnhCorrection.cnh_validade
                            ? new Date(cnhCorrection.cnh_validade + "T12:00:00").toLocaleDateString(
                                "pt-BR",
                              )
                            : "---"}
                        </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Estamos verificando seus documentos. Você receberá um aviso assim que for aprovado
                  para pilotar.
                </p>
              </div>
            )}
          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground">Seu cadastro não foi aprovado.</p>
              ...
              {isFeedbackLoading ? (
                ...
                <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-4 text-center">
                  <p className="text-xs text-white/80 mb-3">
                    Não foi possível carregar os detalhes do seu cadastro.
                  </p>
                  <Button
                    size="sm"
                    variant="outline"
